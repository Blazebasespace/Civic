/*
  ...
  1. New Tables
    ...
    - `proposals` - Governance proposals with voting data
...
CREATE POLICY "Users can insert their own citizen record"
  ON citizens FOR INSERT
  TO public
  WITH CHECK (true);

CREATE POLICY "Users can update their own citizen record"
...
-- Insert sample network states
INSERT INTO network_states (name, flag, population, gdp, governance_score, innovation_index, location, established, specialties, partnerships, color) VALUES
